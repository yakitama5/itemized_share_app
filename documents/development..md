...
- 開発
  ...
  ```sh
  flutterfire configure --out=lib/app/core/firebase/config/firebase_options_dev.dart -p [Dev Project ID] --platforms=android,ios -i com.yakuran.yoropic.dev -a com.yakuran.yoropic.dev
  ```

- 本番

  ```sh
  flutterfire configure --out=lib/app/core/firebase/config/firebase_options.dart -p [Prod Project ID] --platforms=android,ios -i com.yakuran.yoropic -a com.yakuran.yoropic
  ```
